...
Usage: RITdb2xlsx.py [-s | --split] -i <input RITdb file> [-o <output XLSX file>]
'''
...
#    Write one row at a time
    ...
    if hasFailed:  # Top Column RED if any results beyond limits
        cell = ws1.cell(1, 6).font = RED

    wb.save(filename=xlFilename)
    print("SUCCESS converting to XLSX.", xlsxFileName)
### end of ritdb2xlsx ###
